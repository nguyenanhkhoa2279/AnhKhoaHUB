...
-- Hook functions to disable effects
...
CFrameQuest = CFrame.new(9638, -1993, 9615)
CFrameMon = CFrame.new(9818.401, -1962.396, 9810.835)
...
CFrameQuest = CFrame.new(9638, -1993, 9615)
CFrameMon = CFrame.new(9653.319, -1928.222, 9914.895)
end
end
end

-- Material monster function
function MaterialMon()
    ...
    if World1 then
        ...
        -- ... (giữ nguyên phần còn lại của MaterialMon)
        end
    elseif World2 then
        -- ... (giữ nguyên phần World2)
    elseif World3 then
        -- ... (giữ nguyên phần World3)
    end
end
...
LGa:AddButton({
 ...
 Teleport1:CreateDropdown({
	Title = "Select NPC",
	List = {"Random Devil Fruit","Blox Fruits Dealer","Remove Devil Fruit","Ability Teacher","Dark Step","Electro","Fishman Karate"},
	Multi = false,
	Value = "Random Devil Fruit",
	Callback = function(Value)
		_G.SelectNPC = Value
	end
})
...
if World2 then
 Teleport1:CreateDropdown({
	Title = "Select NPC",
	List = {"Dargon Berath","Mtsterious Man","Mysterious Scientist","Awakening Expert","Nerd","Bar Manager","Blox Fruits Dealer","Trevor","Enhancement Editor","Pirate Recruiter","Marines Recruiter","Chemist","Cyborg","Ghoul Mark","Guashiem","El Admin","El Rodolfo","Arowe"},
	Multi = false,
	Value = "Dargon Berath",
	Callback = function(Value)
		_G.SelectNPC = Value
...
if World3 then
 Teleport1:CreateDropdown({
	Title = "Select NPC",
	List = {"Blox Fruits Dealer","Remove Devil Fruit","Horned Man","Hungey Man","Previous Hero","Butler","Lunoven","Trevor","Elite Hunter","Player Hunter","Uzoth"},
	Multi = false,
	Value = "Mansion",
	Callback = function(Value)
		_G.SelectNPC = Value
